let zh = {
    ...
    'mockup': '一般我會先製作平面視覺圖供客戶參閱，確認無誤後才會進入 HTML 切版的部分。在繪製 Mockup 時，同時也在建立視覺模組、訂下一致性的設計規範。前置作業定義好標準，團隊共識便能有依據，對後續的工作十分有利。',
    'deploy': '版型也是由我產出配置，在設計時便已評估可行性並訂下標準，不至於出現不切實際的虛華畫面。初期越有充分的規劃，之後越能降低所花費的時間及困難度。在部屬 HTML 及 CSS 這部分便是相對輕鬆快速。',
